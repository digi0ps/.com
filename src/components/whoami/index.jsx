    ...
    <div className="whoami">
      ...
      <article>
        <p>
          ...
          My name is Sriram and I come from the wonderful city of{" "}
          ...
          Vellore Institute of Technology. I began programming in high school
          with some web development and C++. However, through my college years,
          I deep dived into full stack development with Django and React as my
          go to choice of frameworks.
        </p>
        <p>
          Currently I'm at <OLA href="https://www.gojek.io/">gojek</OLA> where
          we try to provide the best pickup experience for the customer, which
          means I look at latitudes and longitudes everyday. My daily work
